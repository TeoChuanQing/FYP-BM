...
const quizType = "kesalahan_bahasa";
...
function getKesalahanAnswerText(
  answers: Record<string, string>,
  questionId: string
): string {
  const wrong = answers[questionId + "_wrong"] || "";
  const correct = answers[questionId + "_correct"] || "";
  return "Kesalahan: " + (wrong || "-") + " | Pembetulan: " + (correct || "-");
}
...
export default function KesalahanBahasaLatihanPage() {
          ...
          questions.map((question, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="practice-question-text">{extractSentence(question.question_text)}</p>
                ...
                {feedback && (
                  ...
                  >
                    <p>
                      ...
                      {getKesalahanAnswerText(answers, question.question_id) ||
